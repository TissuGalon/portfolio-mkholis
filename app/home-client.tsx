...
import { ProjectItem } from "@/lib/portfolio";
...
function PortfolioSection({ projects }: { projects: ProjectItem[] }) {
    ...
    <section className="max-w-6xl mx-auto px-6 py-20" id="portfolio">
      ...
      <div className="mb-12 space-y-8">
        ...
        <div className="flex items-center gap-3">
          ...
          {projects.length > 0 && (
            <span className="sr-only text-[10px] font-black tracking-[0.3em] text-gray-400 uppercase">
      ...
      {filteredProjects.length === 0 ? (
        <div className="text-center py-20 bg-black/5 dark:bg-white/5 rounded-3xl border border-dashed border-black/10 dark:border-white/10">
          <p className="text-gray-500 dark:text-gray-400 text-lg">
            No projects displayed and user-friendly empty state is shown.
          </p>
        </div>
      ) : (
