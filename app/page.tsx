        ...
        >
          <div className="w-full h-[400px] md:h-[500px]">
            <MagicCard
              ...
              gradientColor={resolvedTheme == "light" ? "violet" : "#e9e9e9ff"}
              gradientOpacity={0.1}
            >
              <img
                alt="Muhammad Kholis"
          ...
          >
            <div className="text-primary text-md leading-relaxed ">
              <TextAnimate>
                ...
                Politeknik Negeri Lhokseumawe dengan minat dan keahlian di
                bidang pengembangan aplikasi mobile dan web. Berpengalaman dalam
              ...
              {[
                ...
                >
                  <MagicCard
                    ...
                    gradientOpacity={0.1}
                  >
                    <AuroraText className="font-semibold text-lg mb-2">
                      {skill.title}
                    </AuroraText>
                    <p className="dark:text-gray-400 text-gray-600">
                      {skill.content}
...
function PortfolioSection() {
  ...
  // ⚡ Bolt: Memoize filtered projects to prevent recalculation on every render
  // Also, calculate search lower case once instead of for every item
  const filteredProjects = useMemo(() => {
    ...
    return projects.filter((project) => {
      ...
      const matchesSearch =
        ...
        project.desc.toLowerCase().includes(lowerSearch);
                  ...
                  <div className="flex flex-col justify-between flex-1 p-6">
                    ...
                    >
                      <ShimmerButton
                        ...
                        shimmerColor={
                          resolvedTheme == "light" ? "violet" : "violet"
                        }
                      >
